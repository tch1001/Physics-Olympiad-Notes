...
\begin{itemize}
    \item If force is at $\theta_{rF} = 90^\circ$ with respect to the origin, maximal torque.
    \item If force is at $\theta_{rF} = 0^\circ$ with respect to the origin, no torque. More on this in \ref{chap:centralforce}.
...
Now that we have covered friction, normal contact force, and tension (Section \ref{sec:fnt}) and Torque (Section \ref{sec:torque}), we can now learn some olympiad tricks to solve statics questions!
\subsection{Balancing Torque (Intersection of 3 Lines)}
